...
public class ACLPropertySection extends AbstractPropertySection {
	...
	public class MailDetailComposite extends ImixsDetailComposite {
		...
		public void createBindings(final EObject be) {
			...
			Value valueUpdateACL = ImixsBPMNPlugin.getItemValueByName((BaseElement) be,
					"keyUpdateACL", "xs:boolean", "false");
			...
			aclComposite.setLayoutData(new GridData(SWT.FILL, SWT.TOP, true,
					true, 3, 1));
			...
			Label labelWidget = getToolkit()
					.createLabel(aclComposite, "Owner:");
			labelWidget.setFont(new Font(getDisplay(), "Arial", 11, SWT.BOLD));

			labelWidget.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false,
					false, 2, 1));

			labelWidget = getToolkit()
					.createLabel(aclComposite, "Read Access:");
			labelWidget.setFont(new Font(getDisplay(), "Arial", 11, SWT.BOLD));
			labelWidget.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false,
					false, 2, 1));
			labelWidget = getToolkit().createLabel(aclComposite,
					"Write Access:");
			labelWidget.setFont(new Font(getDisplay(), "Arial", 11, SWT.BOLD));
			labelWidget.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false,
					false, 2, 1));
