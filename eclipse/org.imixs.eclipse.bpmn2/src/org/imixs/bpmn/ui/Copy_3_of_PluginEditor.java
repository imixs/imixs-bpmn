 ...
 *
 */
public class Copy_3_of_PluginEditor extends ObjectEditor {
	 ...
	 * @param feature
	 */
	public Copy_3_of_PluginEditor(AbstractDetailComposite parent, EObject obj,
	...
	protected Control createControl(Composite parentcomposite, String label,
		...
		// == Button composite
		Composite compositeButtons =  getToolkit().createComposite(editorComposite,
				SWT.NONE);
		...
		Button button2 = getToolkit().createButton(compositeButtons, "Edit...",
				SWT.PUSH);
		 button2 = getToolkit().createButton(compositeButtons, "up...",
				SWT.PUSH);
		 button2 = getToolkit().createButton(compositeButtons, "down...",
					SWT.PUSH);
