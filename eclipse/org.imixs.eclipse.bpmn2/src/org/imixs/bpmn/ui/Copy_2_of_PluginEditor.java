 ...
 *
 */
public class Copy_2_of_PluginEditor extends ObjectEditor {
	 ...
	 * @param feature
	 */
	public Copy_2_of_PluginEditor(AbstractDetailComposite parent, EObject obj,
...
//		editorComposite = new Composite(parentcomposite, SWT.NONE | SWT.TRANSPARENT);
...
//				1, 1));
		...
		GridData gd = new GridData(SWT.FILL, SWT.FILL, true, true, 0, 0);
		gd.widthHint = 250;
		gd.heightHint = 180;
